...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset(videoDataSource: 'assets/Butterfly-209.mp4');
...
class _BumbleBeeRemoteVideoState extends State<_BumbleBeeRemoteVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
      videoDataSource: 'https://flutter.github.io/assets-for-api-docs/assets/videos/bee.mp4',
...
class _PlayerVideoAndPopPageState extends State<_PlayerVideoAndPopPage> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset(videoDataSource: 'assets/Butterfly-209.mp4');
