...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  VideoPlayerController.asset(String s, 
      ...
      : assert(videoDataSource != null || audioDataSource != null, 'At least Video or Audio must be provided'),
  ...
  /// `'file://${file.path}'`.
  VideoPlayerController.file({File? video, File? audio, this.closedCaptionFile, this.videoPlayerOptions})
      : assert(video != null || audio != null, 'At least Video or Audio must be provided'),
        videoDataSource = video != null ? 'file://${video.path}' : null,
        audioDataSource = audio != null ? 'file://${audio.path}' : null,
  ...
  VideoPlayerController.contentUri({Uri? videoUri, Uri? audioUri, this.closedCaptionFile, this.videoPlayerOptions})
      : assert(videoUri != null || audioUri != null, 'At least Video or Audio must be provided'),
        assert(defaultTargetPlatform == TargetPlatform.android,
            'VideoPlayerController.contentUri is only supported on Android.'),
        videoDataSource = videoUri.toString(),
        audioDataSource = audioUri != null ? audioUri.toString() : null,
  ...
  /// The URI to the audio file. This will be in different formats depending on
  /// the [DataSourceType] of the original video.
